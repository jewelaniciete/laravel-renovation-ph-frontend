                        ...
                        <div class="grid grid-cols-12 gap-y-10 lg:gap-10">
                            <div class="col-span-12 lg:col-span-8">
                                <div class="border rounded-md border-gray-100/30 dark:border-neutral-600/80">
                                    <div class="relative">
                                        <img src="/images/job-detail.jpg" alt="" class="rounded-md img-fluid mb-7">
                                        <div class="absolute z-20 -bottom-7 left-7">
                                            <img src="/images/featured-job/img-10.png" alt="" class="rounded-md img-fluid">
                                        </div>
                                    </div>
                                    <div class="p-6">
                            ...
                            <div class="col-span-12 space-y-6 lg:col-span-4">
                                ...
                                <div class="border rounded border-gray-100/30 dark:border-neutral-600/80">
                                    <div class="p-6">
                                        <div>
                                            <img src="/images/featured-job/img-02.png" alt="" class="mx-auto img-fluid">
