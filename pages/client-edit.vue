...
const profileUpdate = async () => {
  ...
  try {
    ...
    const response = await fetch(
      `http://localhost:8000/api/${endpoint}/profile-update`,
      {
        method: "POST",
        body: body,
        headers: {
    ...
    if (response.ok) {
      ...
      console.error(
        `Failed to update ${userType} profile:`,
        response.statusText
      );
      Toastify({
...
async function profileView() {
  ...
  const response = await fetch(
    `http://localhost:8000/api/${endpoint}/profile-view`,
    {
      method: "GET",
      headers: {
        Accept: "application/json",
                  ...
                  <div class="">
                    <div class="">
                      ...
                      <div class="flex flex-col w-full lg:flex-row">
                        <div v-if="showProfile" class="relative flex-col items-center justify-center text-center lg:text-start lg:items-start lg:justify-start mt-custom lg:ml-custom">
                          ...
                          <div v-if="showModal" class="relative z-50 modal" id="modal-id_profile"
                        ...
                        <div v-else class="relative flex-col items-center justify-center w-full text-center lg:text-start lg:justify-start lg:items-start mt-custom lg:ml-custom">
                          <div class="flex items-center justify-center lg:items-start lg:justify-start">
                      ...
                      <div v-for="tab in items" :key="tab.tab" class="flex-auto">
                        <li class="flex-auto mr-2 -mb-px text-center last:mr-0">
                          <a class="block px-5 py-3 text-xs font-bold leading-normal text-gray-400 uppercase rounded shadow-xl cursor-pointer"
                            @click="openTab = tab.tab" :class="{
                              'text-green-700 bg-white': openTab !== tab.tab,
                              'text-gray-900 bg-green-500\/75':
                                openTab === tab.tab,
                            }">
                            {{ tab.title }}
                          </a>
                    ...
                    <div class="relative flex flex-col w-full min-w-0 mb-4 break-words bg-white shadow-lg rounded-xl">
                      <div class="flex-auto px-4 py-5">
                        <div v-for="tab in items" :key="tab.tab" class="tab-content tab-space">
                          <div :class="{
                            hidden: openTab !== tab.tab,
                            block: openTab === tab.tab,
                          }">
