...
const formData = ref({
  ...
  password: '',
  remember_me: '',
  userType: 'client' // default to client, can be 'client' or 'professional'
});
                    ...
                    <div class="grid grid-cols-12">
                        <div class="col-span-12 lg:col-span-10 lg:col-start-2">
                          ...
                          <div class="flex space-x-2">
                            <button type="button" :class="['w-full py-2.5 rounded', formData.userType === 'client' ? 'bg-green-400\/20 text-white' : 'bg-gray-500\/20 text-gray-500']" @click="setUserType('client')">Client</button>                          </div>
                        </div>
