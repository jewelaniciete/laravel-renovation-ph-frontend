                            ...
                            <div>
                                <div class="mt-24">
                                    ...
                                    <div v-if="showModal"
                                        ...
                                        <div
                                            class="relative w-100 h-100 bg-white rounded-lg shadow-xl dark:bg-neutral-800">
                                            <div
                                                class="flex justify-between items-center bg-gray-200 rounded-t-md p-4 border-b dark:border-gray-700">
                                            ...
                                            <div class="p-6 space-y-6 ">
                                                <textarea type="text"
                                                    class="w-full p-2 rounded-md resize-none border-none text-2xl dark:bg-neutral-700 text-black dark:text-white h-50 dark:border-gray-600 focus:ring-0"
                                                    placeholder="What's on your mind?" />
                                            </div>
                                            <div class="p-3">
                                                <div
                                                    class="flex resize-none rounded-md border p-2  justify-between text-black dark:border-gray-600 dark:bg-neutral-700 dark:text-white">
                                                    <p class="select-none text-lg">Add to your post</p>
                                                    <div>
                                                        <img id="uploadImage" class="w-26 cursor-pointer"
                                            ...
                                            <div
                                                class="flex items-center justify-center p-4 border-t dark:border-gray-700">
                                                <button @click="showModal = false"
                                                    class="px-4 py-2 text-black bg-gray-200  w-full rounded-md hover:bg-gray-500">
                                                    Post
                                                </button>
                                            </div>
                                        </div>
